...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-md-9">
        <div class="content" id="content-control"> <!-- class添加table-responsive可左右滑动 -->
            ...
            <div class="col-sm-10">
                <form action="${pageContext.request.contextPath }/BlogWriteServlet" method="post"
                      enctype="multipart/form-data" id="checkForm">
                    <div class="form-group">
                        <label for="exampleInputTopic1">输入博客名字：</label>
                        <input type="text" class="form-control" placeholder="输入博客名字" name="blog_name">
                    </div>
                    <br>
                    <div class="form-group">
                        <label for="exampleInputTopic1">输入博客主题：</label>
                        <input type="text" class="form-control" placeholder="输入博客主题" name="blog_titile">
                    ...
                    <div class="wangEditor-txt" contenteditable="true">
                        ...
                        <textarea class="form-control" rows="8" placeholder="输入博客内容" name="blog_context"></textarea>
                    </div>
