...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<%=basePath%>pages/plugin/wangEditor/css/wangEditor.min.css"><%--用于显示评论框--%>
            ...
            <div class="col-lg-9 col-md-9 w_main_left">
                <div class="panel panel-default  mb-20">
                    ...
                    <div class="panel-body pt-10 pb-10">
                        ...
                        <p class="box_c"><span class="d_time">发布时间：${aBlog.blog_createtime}</span><span>编辑：<a href="mailto:wfyv@qq.com">wilco</a></span><span>阅读（88646）</span></p>
                        <ul class="infos">

                            <p> <strong>${aBlog.blog_context}</strong></p>
                            <c:forEach items="${photos}" var="p">

                            <p>&nbsp;<img src="upload/${p.photo_address}" alt="${p.photo_desc}" width="700" height="886"></p>
                        ...
                        <div class="panel-body" style="margin: 0 3%;">
                                    ...
                                    <li class="item cl"> <a href="#"><i class="avatar size-L radius"><img alt="" src="http://qzapp.qlogo.cn/qzapp/101388738/1CF8425D24660DB8C3EBB76C03D95F35/100"></i></a>
                                        <div class="comment-main">
                                            <header class="comment-header">
                                                <div class="comment-meta"><a class="comment-author" href="#">${comm.username}</a>
                                                    <time title="2014年8月31日 下午3:20" datetime="2014-08-31T03:54:20" class="f-r">${comm.commtime}</time>
                                                </div>
                                            </header>
                            ...
                            <div class="mt-20" id="ct">
                                ...
                                <div id="err" class="Huialert Huialert-danger hidden radius">成功状态提示</div>
                                    <textarea class="form-control" rows="8" placeholder="看完留一发吧" name="re_content"></textarea>
