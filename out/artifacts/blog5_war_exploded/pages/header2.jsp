...
<nav class="navbar navbar-inverse navbar-fixed-top  ">
    <div class="container">
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed " id="navbar-button" data-toggle="collapse"
            ...
            <div class="navbar-brand" id="navbar-brand">
                <div class="dropdown">
                    <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1"
                            data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" style="border: 0;">
                        <img id="img-head" src="${pageContext.request.contextPath}/pages/img/100.jpg" width="45"
                   ...
                   <li><a href="">注册</a></li>
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                        <li>
                            <a href="${pageContext.request.contextPath}/FindUserDataServlet?userid=${user.userid}">个人中心</a>
                        </li>
                        ...
                        <li>
                            <a href="${pageContext.request.contextPath}/FindMyBlogServlet?userid=${user.userid} ">我的博客</a>
                        </li>
        ...
        <div id="navbar" class="navbar-collapse collapse">
            <form class="navbar-form navbar-right" role="search"
                  action="${pageContext.request.contextPath}/FindBlogByName" method="post">
                <div class="form-group">
                    <input type="text" id="search" class="form-control" placeholder="输入查询博客主题" name="blog_name"
