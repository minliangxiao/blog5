								...
								<table width="100%" border="0" cellspacing="0" cellpadding="0">
									<tr>
										...
										<td width="155" valign="bottom"
                                            ...
                                            &nbsp;&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-align-left"><strong>
                                            <%--这个退出不知道如何操作--%>
                                            <a href="${pageContext.request.contextPath}/SignOutServlet"  target="_parent"> 退出系统</a></strong></span>
										</td>
