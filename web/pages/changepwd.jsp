...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-md-9">
        <div class="content" id="content-control"> <!-- class添加table-responsive可左右滑动 -->
            ...
            <div class="col-sm-10">
                <form action="${pageContext.request.contextPath }/ChangePWDServlet" method="post"  id="checkForm">
                    ...
                    <br>
                      ...
                      <div class="input-group">
                        <label for="exampleInputTopic1">修改密码：</label>
                        <input type="password" class="form-control"  name="userpwd">
                    </div>
                    <h3 style="color:#cc0000  ">${mesage}</h3>

                    <input type="hidden" placeholder="${user.userid}" name="userid" value="${user.userid}">
