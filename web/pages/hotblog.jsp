                ...
                <c:forEach items="${page.datalist}" var="n">
                    <li class="index_arc_item">
                        ...
                        <div class="date_hits">
                            ...
                            <p class="hits"><i class="Hui-iconfont" title="点击量" style="color: #cc0000">&#xe6c1;</i>${n.blog_hot}° </p>
                            <p class="commonts"><i class="Hui-iconfont" title="评论量"style="color: #cc0000">&#xe622;</i>
                                ${n.blog_renumber}</p>
                        </div>
                ...
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        <c:if test="${page.currentPage==1}">
                            <li class="disabled">
                                <a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=1&&rows=12&&userid=${user.userid}"  aria-label="Previous">
                        ...
                        <c:if test="${page.currentPage!=1}">
                            <li >
                                <a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=${page.currentPage-1}&&rows=12&&userid=${user.userid}" aria-label="Previous">
                        ...
                        <c:forEach begin="1" end="${page.totalPage}" var="i">
                            <c:if test="${page.currentPage==i}">
                                <li class="active"><a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=${i}&&rows=12&&userid=${user.userid}">${i}</a></li>
                            </c:if>
                            <c:if test="${page.currentPage!=i}">
                                <li ><a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=${i}&&rows=12&&userid=${user.userid}">${i}</a></li>
                            </c:if>
                        </c:forEach>

                        <c:if test="${page.currentPage==page.totalPage}">
                            <li class="disabled">
                                <a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=${page.totalPage}&&rows=12"  aria-label="Previous">
                        ...
                        <c:if test="${page.currentPage!=page.totalPage}">
                            <li >
                                <a href="${pageContext.request.contextPath}/FindHotServlet?currentPage=${page.currentPage+1}&&rows=12" aria-label="Previous">
