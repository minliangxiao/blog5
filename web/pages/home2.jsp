            ...
            <div class="art_content">
                <ul class="index_arc">
                    ...
                    <li class="index_arc_item"><%--blog_id--%>
                        <a href="<%=basePath%>showBlogServlet?blog_id=${blog.blog_id}&&user=user" class="pic">
                            <img class="lazyload" src="${pageContext.request.contextPath}/upload/${blog.photos.photo_address}" height="90" alt="博客图片" /><!--  data-original="admintemp/art.jpg"不知道是什么意思-->
                        </a><%--这个图片之后在想--%>
                        <h4 class="title"><a href="<%=basePath%>showBlogServlet?blog_id=${blog.blog_id}&&user=user">${blog.blog_titile} </a></h4>
                        <div class="date_hits">
                            <span>发布人id：${blog.userid}</span>
                            <span>时间：${blog.blog_createtime}</span>
                            <span>博客名称：<a href="<%=basePath%>showBlogServlet?blog_id=${blog.blog_id}&&user=user">${blog.blog_name}</a></span>
                            <p class="hits" style="color: #cc0000"><i class="Hui-iconfont" title="点击量">&#xe6c1;</i> ${blog.blog_hot}° </p>
                            <p class="commonts" style="color:#cc0000 "><i class="Hui-iconfont" title="评论量">&#xe622;</i> <span class="cy_cmt_count">${blog.blog_renumber}</span></p>
                        </div>
                        <div class="desc"><%--这是正文--%>
                            ${blog.blog_context}
                ...
                <ul class="pagination">
                    <c:if test="${newblogs.currentPage==1}">
                       <li class="disabled">
                        <a href="${pageContext.request.contextPath}/HomeServlet?currentPage=1"  aria-label="Previous">
                    ...
                    <c:if test="${newblogs.currentPage!=1}">
                        <li >
                            <a href="${pageContext.request.contextPath}/HomeServlet?currentPage=${newblogs.currentPage-1}"  aria-label="Previous">
                    ...
                    <c:forEach begin="1" end="${newblogs.totalPage}" var="i">
                        ...
                        <c:if test="${newblogs.currentPage==i}">
                            <li class="active"><a href="${pageContext.request.contextPath}/HomeServlet?currentPage=${i}">${i}</a></li>
                        </c:if>
                        <c:if test="${newblogs.currentPage!=i}">
                            <li ><a href="${pageContext.request.contextPath}/HomeServlet?currentPage=${i}">${i}</a></li>
                        </c:if>
                    ...
                    <c:if test="${newblogs.currentPage==newblogs.totalPage}">
                        <li class="disabled">
                            <a href="${pageContext.request.contextPath}/HomeServlet?currentPage=${newblogs.totalPage}"  aria-label="Previous">
                ...
                <div class="panel-body">
                    ...
                    <div class="slideTxtBox">
                        <div class="bd">
                            ...
                            <div class="mt-20 bg-fff box-shadow radius mb-5">
                                <div class="tab-category">
                                    <a href="${pageContext.request.contextPath}/FindAllDiscussServlet?user=user"><strong class="current">公告</strong></a>
                                </div>
                            </div>
                            <ul><%--这是发公告的--%>
                                ...
                                <li><a href="${pageContext.request.contextPath}/UpdataDiscussServlet?user=user&&discussid=${dis.discussid}" style="color:#cc0000 ">${dis.discuss_title}</a></li><%--这个后期还需要完善--%>
                                </c:forEach>
                            </ul>
                ...
                <div class="tab-category-item">
                    <ul class="index_recd clickTop">
                        ...
                        <li>
                            ...
                            <p class="hits" style="color: #cc0000"><i class="Hui-iconfont" title="点击量">&#xe6c1;</i> ${hot.blog_hot}° </p>
