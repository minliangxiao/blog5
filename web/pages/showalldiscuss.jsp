            ...
            <ul class="index_arc">
                ...
                <c:forEach items="${page.datalist}" var="n">
                    <li class="index_arc_item">
                        <h4 class="title"><a href="<%=basePath%>UpdataDiscussServlet?user=user&&discussid=${n.discussid}" style="color: #cc0000">公告主题：${n.discuss_title}</a></h4><%--个人博客应该选择什么样的域名和域名后缀--%>
                        <div class="date_hits">
                    ...
                    <ul class="pagination">
                        ...
                        <c:forEach begin="1" end="${page.totalPage}" var="i">
                            ...
                            <c:if test="${page.currentPage==i}">
                                <li class="active"><a href="${pageContext.request.contextPath}/FindAllDiscussServlet?currentPage=${i}&&rows=12&&user=user">${i}</a></li>
                            </c:if>
                            <c:if test="${page.currentPage!=i}">
                                <li ><a href="${pageContext.request.contextPath}/FindAllDiscussServlet?currentPage=${i}&&rows=12&&user=user">${i}</a></li>
                            </c:if>
                        ...
                        <c:if test="${page.currentPage==page.totalPage}">
                            <li class="disabled">
                                <a href="${pageContext.request.contextPath}/FindAllDiscussServlet?currentPage=${page.totalPage}&&rows=12&&user=user "  aria-label="Previous">
                        ...
                        <c:if test="${page.currentPage!=page.totalPage}">
                            <li >
                                <a href="${pageContext.request.contextPath}/FindAllDiscussServlet?currentPage=${page.currentPage+1}&&rows=12&&user=user" aria-label="Previous">
