...
<div class="container">
    <div class="col-sm-6">
        ...
        <h3>注册用户</h3>
        <form action="${pageContext.request.contextPath}/AddUserServlet" method="post" id="checkForm">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" id="suerPassword" placeholder="请确认密码" required name="userpwd2" >

            </div>
            <div class="form-group">
                <label for="phoneNo">qq号</label>
